...
<h1 style="font-size:300%; color: #9E089E; font-family:Georgia"> SIMULADO NACIONAL INSPER E FGV<br>
...
if simulado_selecionado == 'Insper':
    ...
    if login_aluno != '':
        ...
        matematica_tabela = pd.merge(matematica_aluno_media,matematica_detalhes_media, on = 'Assunto', how = 'right')
        ...
        matematica_tabela3 = pd.merge(matematica_tabela2,matematica_aluno_media3, on = 'Assunto', how = 'left')
        ...
        matematica_tabela3['Resultado Individual'].fillna('0%', inplace=True)
        ...
        if len(resultados_matematica['Nome do aluno(a)']) >= 0:
                ...
                with col2:
                    ...
                    if len(resultados_matematica['Nome do aluno(a)']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            ...
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(0,0)), 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    else:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                ...
                with col4:
                    ...
                    if len(resultados_matematica['Nome do aluno(a)']) == 0:
                        fig_c2 = go.Figure(go.Indicator(
                            ...
                            value=0,
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(0,0))},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    else:
                        fig_c2 = go.Figure(go.Indicator(
                            mode="number+delta",
            ...
            with st.container():
                ...
                # create the bins
                    ...
                    fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                                ...
                                margin=dict(l=1, r=1, b=1, t=30))
                    if len(resultados_matematica['Nome do aluno(a)']) == 0:
                        fig.add_vline(x=int(0), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                    else:
            ...
            linguagens_tabela = pd.merge(linguagens_aluno_media,linguagens_detalhes_media, on = 'Assunto', how = 'right')
            ...
            linguagens_tabela3 = pd.merge(linguagens_tabela2,linguagens_aluno_media3, on = 'Assunto', how = 'left')
            ...
            ciencias_tabela = pd.merge(ciencias_aluno_media,ciencias_detalhes_media, on = 'Assunto', how = 'right')
            ...
            ciencias_tabela3 = pd.merge(ciencias_tabela2,ciencias_aluno_media3, on = 'Assunto', how = 'left')
            ...
            with st.container():
                ...
                with col2:
                    st.markdown(html_card_header1_disc, unsafe_allow_html=True)
                    if len(resultados_ciencias_fim['Nome do aluno(a)']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
        ...
        redacao_tabela = pd.merge(redacao_aluno_media,redacao_detalhes_media, on = 'Competência', how = 'right')
        ...
        redacao_tabela3 = pd.merge(redacao_tabela2,redacao_aluno_media3, on = 'Competência', how = 'left')
        ...
        if len(redacao_tabela3['Status']) != 0:
            ...
            with st.container():
                ...
                with col2:
                    st.markdown(html_card_header1_disc, unsafe_allow_html=True)
                    if len(redacao_aluno_media['Nota na questão']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
        ...
        with st.container():
            ...
            with col2:
                ...
                fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                            ...
                            margin=dict(l=1, r=1, b=1, t=30))
                if len(base_resultados_2fase_aluno2) == 0:
                    fig.add_vline(x=int(round(0,1)), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                else:
        ...
        with st.container():
            ...
            with col2:
                st.markdown(html_card_header1, unsafe_allow_html=True)
                if len(resultado_final_aluno2) == 0:
                    fig_c1 = go.Figure(go.Indicator(
                        mode="number+delta",
                        value=round(0,1),
                        number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
...
elif simulado_selecionado == 'FGV':

    base_matriz_fgv = pd.read_csv('./matrizquestoes_sn_fgv.csv')

    base_resultados_fgv = pd.read_csv('./resultado1fase_sn_fgv.csv')

    base_resultados_fgv['disciplina'] = ''
    base_resultados_fgv['assunto'] = ''
    ...
    if login_aluno:
        # Substituindo o range(len(...)) pelo tqdm para adicionar a barra de progresso
        for i in tqdm(range(len(base_resultados_fgv['atividade_nome'])), desc='Processando dados', unit='item'):
            turma_atual = base_resultados_fgv['turma'][i]
            simulado_atual = base_resultados_fgv['Simulado'][i]
            num_exercicio_atual = base_resultados_fgv['num_exercicio'][i]

            matriz_questoes = base_matriz_fgv[base_matriz_fgv['Simulado'] == simulado_atual]
            ...
            if len(matriz_questoes) > 0:
                base_resultados_fgv['disciplina'][i] = matriz_questoes['disciplina'][0]
                base_resultados_fgv['assunto'][i] = matriz_questoes['assunto'][0]

            # Atualizando a barra de progresso e o componente de texto a cada iteração
            progress_bar.progress((i + 1) / len(base_resultados_fgv['atividade_nome']))
            percentage_text.text(f"{round((i + 1) / len(base_resultados_fgv['atividade_nome']) * 100)}%")
    ...
    base_fgv = base_resultados_fgv.copy()

    base_fgv.rename(columns = {'atividade_nome':'Nome da avaliação','turma':'Turma','aluno_nome':'Nome do aluno(a)','aluno_login':'Login do aluno(a)','num_exercicio':'Número da questão','resp_aluno':'Resposta do aluno(a)','gabarito':'Gabarito','certo_ou_errado':'Certo ou errado','tempo_no_exercicio(s)':'Tempo na questão','valor_do_exercicio':'Valor da questão','disciplina':'Disciplina','frente':'Frente','assunto':'Assunto'}, inplace = True)
    base_fgv['Resposta do aluno(a)'] = base_fgv['Resposta do aluno(a)'].fillna('x')
    base_fgv['Tempo na questão'] = base_fgv['Tempo na questão'].fillna(0)
    base_fgv['Valor da questão'] = base_fgv['Valor da questão'].apply(lambda x: float(str(x).replace(".", "").replace(",", ".")))

    ### Resultados Gerais

    base_fgv['Acerto'] = 0.00
    base_fgv['Nota na questão'] = 0.00
    base_fgv['Novo Nota na questão'] = 0.00
    base_fgv['Novo Valor da questão'] = base_fgv['Valor da questão']

    import numpy as np

    base_fgv['Acerto'] = np.where((base_fgv['Certo ou errado'] == 'certo'), 1, 0)
    base_fgv['Novo Nota na questão'] = base_fgv['Acerto'] * base_fgv['Novo Valor da questão']
    base_fgv['Nota na questão'] = base_fgv['Acerto'] * base_fgv['Valor da questão']

    resultados_gerais_fgv = base_fgv.groupby(['Nome da avaliação','Turma','Nome do aluno(a)','Login do aluno(a)','Simulado']).sum().reset_index()

    resultados_gerais_fgv2 = resultados_gerais_fgv.groupby(['Turma','Nome do aluno(a)','Login do aluno(a)','Simulado']).sum().reset_index()
    resultados_gerais_fgv2_aux = resultados_gerais_fgv2.copy()

    resultados_gerais_fgv3 = resultados_gerais_fgv2_aux.sort_values(by = 'Nota na questão', ascending = False).reset_index(drop = True)  
    resultados_gerais_fgv3["Login do aluno(a)"] = resultados_gerais_fgv3["Login do aluno(a)"].apply(extract_login)              

    if len(login_aluno) > 0:
        nome_aluno3 = resultados_gerais_fgv3[resultados_gerais_fgv3['Login do aluno(a)'] == login_aluno]['Nome do aluno(a)'].reset_index()
        turma_aluno = resultados_gerais_fgv3[resultados_gerais_fgv3['Login do aluno(a)'] == login_aluno]['Turma'].reset_index() 
    ...
    if login_aluno != '':
        resultados_gerais_fgv3.to_csv('resultado_compilado_fgv.csv')
        resultados_gerais_aluno_fgv = resultados_gerais_fgv3[resultados_gerais_fgv3['Nome do aluno(a)'] == nome_aluno3['Nome do aluno(a)'][0]].reset_index()
        resultados_gerais_aluno_fgv.rename(columns = {'index':'Classificação'}, inplace = True)
        resultados_gerais_aluno_fgv['Classificação'][0] = resultados_gerais_aluno_fgv['Classificação'][0] + 1
        
        
        resultados_gerais_fgv4 = resultados_gerais_fgv3[resultados_gerais_fgv3['Nota na questão'] > 0]
        resultados_gerais_fgv4_aux = resultados_gerais_fgv4[['Login do aluno(a)','Número da questão','Tempo na questão','Valor da questão','Acerto','Nota na questão']]
        resultados_gerais_fgv5 = resultados_gerais_fgv4_aux.copy()
        #resultados_gerais5 = resultados_gerais4.groupby('Login do aluno(a)').mean().reset_index()

        alunos_fizeram_fgv = pd.DataFrame()
        alunos_fizeram_fgv['Nome do aluno(a)'] = resultados_gerais_fgv4['Nome do aluno(a)']

        ### Resultados gerais do aluno

        numero_candidatos_fgv = len(resultados_gerais_fgv4['Nome do aluno(a)'])
        aux = resultados_gerais_fgv4[resultados_gerais_fgv4['Turma'] == turma_eng]
        aux2 = resultados_gerais_fgv4[resultados_gerais_fgv4['Turma'] == turma_cien]
        numero_eng_cien_fgv = len(aux['Nome do aluno(a)']) + len(aux2['Nome do aluno(a)'])
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Média Geral: """+str(int(round(resultados_gerais_fgv5['Nota na questão'].mean(),0)))+"""</p>
        </div>
        </div>
        """
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Média Geral: """+str(int(round(resultados_gerais_fgv5['Acerto'].mean(),1)))+"""</p>
        </div>
        </div>
        """
        html_card_header3="""
        ...
        <div class="card-body" style="border-radius: 0px 0px 10px 10px; background: #9E089E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#9E089E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Quantidade de alunos: """+str(numero_candidatos_fgv)+"""</p>
        </div>
        </div>
        """
        ...
        with st.container():
            ...
            with col2:
                ...
                fig_c1 = go.Figure(go.Indicator(
                    mode="number+delta",
                    value=round(resultados_gerais_aluno_fgv['Nota na questão'][0],1),
                    number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                    delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_fgv5['Nota na questão'].mean(),-1),0)), 'relative': False},
                    domain={'x': [0, 1], 'y': [0, 1]}))
                fig_c1.update_layout(autosize=False,
                                    width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                    paper_bgcolor="#FFF0FC", font={'size': 20})
            ...
            with col4:
                ...
                fig_c2 = go.Figure(go.Indicator(
                    mode="number+delta",
                    value=round(resultados_gerais_aluno_fgv['Acerto'][0],0),
                    number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                    delta={'position': "bottom", 'reference': int(round(resultados_gerais_fgv5['Acerto'].mean(),0))},
                    domain={'x': [0, 1], 'y': [0, 1]}))
                fig_c2.update_layout(autosize=False,
                                    width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                    paper_bgcolor="#FFF0FC", font={'size': 20})
            ...
            with col6:
                ...
                fig_c3 = go.Figure(go.Indicator(
                    mode="number",
                    value=resultados_gerais_aluno_fgv['Classificação'][0],
                    number={'suffix': "º", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                    delta={'position': "bottom", 'reference': 1, 'relative': False},
                    domain={'x': [0, 1], 'y': [0, 1]}))
                fig_c3.update_layout(autosize=False,
        ...
        ponto = str(round(100*(numero_candidatos_fgv-(resultados_gerais_aluno_fgv['Classificação'][0]-1))/numero_candidatos_fgv,0)).find('.')
        texto = str(round(100*(numero_candidatos_fgv-(resultados_gerais_aluno_fgv['Classificação'][0]-1))/numero_candidatos_fgv,0))[0:ponto]
        html_card_header_destaques_gerais="""
        <div class="card">
        <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #0010B3; padding-top: 60px; width: 495px;
        height: 150px;">
        ...
        with st.container():
            ...
            with col2:
                # create the bins
                counts, bins = np.histogram(resultados_gerais_fgv4['Nota na questão'], bins=range(0, 1100, 100))
                bins = 0.5 * (bins[:-1] + bins[1:])
                fig = px.bar(x=bins, y=counts, labels={'x':'Nota no simulado', 'y':'Número de alunos'})
                fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                            plot_bgcolor="#FFF0FC", font={'color': "#9E089E", 'size': 14, 'family': "Georgia"}, height=400,
                            ...
                            legend=dict(orientation="h",
                                        ...
                                        x=0.01),
                            margin=dict(l=1, r=1, b=1, t=30))
                fig.add_vline(x=int(round(resultados_gerais_aluno_fgv['Nota na questão'][0],1)), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                fig.add_vline(x=int(round(truncar(resultados_gerais_fgv5['Nota na questão'].mean(),-1),0)), line_width=7, line_dash="dash", line_color="#01ECEC", annotation_text="Média", annotation_position="top right")
                fig.update_xaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=6, rangemode="tozero",
                            showgrid=False, gridwidth=0.5, gridcolor='#f6f6f6')
                fig.update_yaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=10, rangemode="tozero",
                            showgrid=True, gridwidth=0.5, gridcolor='#f6f6f6')
            ...
            with col4:
                ...
                st.markdown(html_br, unsafe_allow_html=True)
                st.markdown(html_br, unsafe_allow_html=True)
                if resultados_gerais_aluno_fgv['Classificação'][0] <= numero_candidatos_fgv:
                    st.markdown(html_card_header_destaques_gerais, unsafe_allow_html=True)
            with col5:
                st.write("")
        ...
        resultados_gerais_disciplina_fgv3 = resultados_gerais_disciplina_fgv2.sort_values(by = 'Nota na questão', ascending = False).reset_index(drop = True)
        
        resultados_gerais_disciplina_fgv3['Nota na questão'] = 1000*resultados_gerais_disciplina_fgv3['Nota na questão']/resultados_gerais_disciplina_fgv3['Valor da questão']
    
        resultados_gerais_disciplina_fgv3_aux = resultados_gerais_disciplina_fgv3.drop(columns = ['Turma','Login do aluno(a)','Nome do aluno(a)'])
        
        resultados_gerais_disciplina_fgv4 = resultados_gerais_disciplina_fgv3_aux.groupby('Disciplina').mean().reset_index()
        resultados_gerais_disciplina_fgv5 = resultados_gerais_disciplina_fgv4.sort_values(by = 'Disciplina', ascending = False)
        ...
        resultados_matematica_fgv = resultados_disciplina_aluno_fgv2[resultados_disciplina_aluno_fgv2['Disciplina'] == 'Matemática'].reset_index()
        resultados_linguagens_fgv = resultados_disciplina_aluno_fgv2[resultados_disciplina_aluno_fgv2['Disciplina'] == 'Língua Portuguesa'].reset_index()
        resultados_ingles_fgv = resultados_disciplina_aluno_fgv2[resultados_disciplina_aluno_fgv2['Disciplina'] == 'Inglês'].reset_index()
        resultados_ciencias_hum_fgv = resultados_disciplina_aluno_fgv2[resultados_disciplina_aluno_fgv2['Disciplina'] == 'Ciências Humanas'].reset_index()
        resultados_ciencias_nat_fgv = resultados_disciplina_aluno_fgv2[resultados_disciplina_aluno_fgv2['Disciplina'] == 'Ciências da Natureza'].reset_index()

        resultados_gerais_disciplina3_mat_fgv = resultados_gerais_disciplina_fgv3[resultados_gerais_disciplina_fgv3['Disciplina'] == 'Matemática'].reset_index(drop = True).reset_index()
        resultados_gerais_disciplina3_lin_fgv = resultados_gerais_disciplina_fgv3[resultados_gerais_disciplina_fgv3['Disciplina'] == 'Língua Portuguesa'].reset_index(drop = True).reset_index()
        resultados_gerais_disciplina3_ing_fgv = resultados_gerais_disciplina_fgv3[resultados_gerais_disciplina_fgv3['Disciplina'] == 'Inglês'].reset_index(drop = True).reset_index()
        resultados_gerais_disciplina3_hum_fgv = resultados_gerais_disciplina_fgv3[resultados_gerais_disciplina_fgv3['Disciplina'] == 'Ciências Humanas'].reset_index(drop = True).reset_index()
        resultados_gerais_disciplina3_nat_fgv = resultados_gerais_disciplina_fgv3[resultados_gerais_disciplina_fgv3['Disciplina'] == 'Ciências da Natureza'].reset_index(drop = True).reset_index()

        classificacao_aluno_mat_fgv = resultados_gerais_disciplina3_mat_fgv[resultados_gerais_disciplina3_mat_fgv['Login do aluno(a)'] == login_aluno].reset_index()
        classificacao_aluno_lin_fgv = resultados_gerais_disciplina3_lin_fgv[resultados_gerais_disciplina3_lin_fgv['Login do aluno(a)'] == login_aluno].reset_index()
        classificacao_aluno_ing_fgv = resultados_gerais_disciplina3_ing_fgv[resultados_gerais_disciplina3_ing_fgv['Login do aluno(a)'] == login_aluno].reset_index()
        classificacao_aluno_hum_fgv = resultados_gerais_disciplina3_hum_fgv[resultados_gerais_disciplina3_hum_fgv['Login do aluno(a)'] == login_aluno].reset_index()
        classificacao_aluno_nat_fgv = resultados_gerais_disciplina3_nat_fgv[resultados_gerais_disciplina3_nat_fgv['Login do aluno(a)'] == login_aluno].reset_index()  
        
        resultados_gerais_disciplina_med_mat_fgv = resultados_gerais_disciplina_fgv5[resultados_gerais_disciplina_fgv5['Disciplina'] == 'Matemática'].reset_index(drop = True)
        resultados_gerais_disciplina_med_lin_fgv = resultados_gerais_disciplina_fgv5[resultados_gerais_disciplina_fgv5['Disciplina'] == 'Língua Portuguesa'].reset_index(drop = True)
        resultados_gerais_disciplina_med_ing_fgv = resultados_gerais_disciplina_fgv5[resultados_gerais_disciplina_fgv5['Disciplina'] == 'Inglês'].reset_index(drop = True)
        resultados_gerais_disciplina_med_hum_fgv = resultados_gerais_disciplina_fgv5[resultados_gerais_disciplina_fgv5['Disciplina'] == 'Ciências Humanas'].reset_index(drop = True)
        resultados_gerais_disciplina_med_nat_fgv = resultados_gerais_disciplina_fgv5[resultados_gerais_disciplina_fgv5['Disciplina'] == 'Ciências da Natureza'].reset_index(drop = True)

        if len(resultados_ciencias_hum_fgv['Disciplina']) == 0:
            resultados_ciencias_fim_fgv = resultados_ciencias_nat_fgv.copy()
            resultados_gerais_disciplina3_fim_fgv = resultados_gerais_disciplina3_nat_fgv.copy()
            classificacao_aluno_fim_fgv = classificacao_aluno_nat_fgv.copy()
            resultados_gerais_disciplina_med_cie_fgv = resultados_gerais_disciplina_med_nat_fgv.copy()
        else:
            resultados_ciencias_fim_fgv = resultados_ciencias_hum_fgv.copy()
            resultados_gerais_disciplina3_fim_fgv = resultados_gerais_disciplina3_hum_fgv.copy()
            classificacao_aluno_fim_fgv = classificacao_aluno_hum_fgv.copy()
            resultados_gerais_disciplina_med_cie_fgv = resultados_gerais_disciplina_med_hum_fgv.copy()
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_mat_fgv['Nota na questão'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        html_card_footer1_disc_med_lin="""
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_lin_fgv['Nota na questão'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        html_card_footer1_disc_med_ing="""
        <div class="card">
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_ing_fgv['Nota na questão'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        if len(resultados_ciencias_hum_fgv['Nota na questão'] == 0):
            html_card_footer1_disc_med_cie="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
            height: 50px;">
                <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_hum_fgv['Nota na questão'].mean(),-1),0)))+"""</p>
            </div>
            </div>
            """
        else:
            ...
            <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
            height: 50px;">
                <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_nat_fgv['Nota na questão'].mean(),-1),0)))+"""</p>
            </div>
            </div>
            """
        html_card_header2_disc="""
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_mat_fgv['Acerto'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        html_card_footer2_disc_med_lin="""
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_lin_fgv['Acerto'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        html_card_footer2_disc_med_ing="""
        <div class="card">
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_ing_fgv['Acerto'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """

        
        if resultados_gerais_aluno_fgv['Turma'][0] != turma_eng and resultados_gerais_aluno_fgv['Turma'][0] != turma_cien:
            html_card_footer2_disc_med_cie="""
        <div class="card">
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_hum_fgv['Acerto'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """
        else:
        ...
        <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #FFA73E; padding-top: 12px; width: 350px;
        height: 50px;">
            <p class="card-title" style="background-color:#FFA73E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Media Geral: """+str(int(round(truncar(resultados_gerais_disciplina_med_nat_fgv['Acerto'].mean(),-1),0)))+"""</p>
        </div>
        </div>
        """  
        html_card_header3_disc="""
        ...
        if resultados_gerais_aluno_fgv['Turma'][0] != turma_eng and resultados_gerais_aluno_fgv['Turma'][0] != turma_cien:
            ...
            <div class="card-body" style="border-radius: 0px 0px 10px 10px; background: #9E089E; padding-top: 12px; width: 350px;
            height: 50px;">
                <p class="card-title" style="background-color:#9E089E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Quantidade de alunos: """+str(numero_candidatos_fgv-numero_eng_cien_fgv)+"""</p>
            </div>
            </div>
            """
        else:
            ...
            <div class="card-body" style="border-radius: 0px 0px 10px 10px; background: #9E089E; padding-top: 12px; width: 350px;
            height: 50px;">
                <p class="card-title" style="background-color:#9E089E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 0px 0;">Quantidade de alunos: """+str(numero_eng_cien_fgv)+"""</p>
            </div>
            </div>
            """
        ...
        """
        #if len(resultados_matematica['Nome do aluno(a)']) != 0:
        if len(resultados_matematica_fgv['Nome do aluno(a)']) >= 0:
            ...
            with st.container():
                ...
                with col2:
                    ...
                    if len(resultados_matematica_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(resultados_matematica_fgv['Nota na questão'][0],1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_mat_fgv['Nota na questão'][0],-1),0)), 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c1.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col4:
                    ...
                    if len(resultados_matematica_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c2 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=resultados_matematica_fgv['Acerto'][0],
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_mat_fgv['Acerto'][0],-1),0))},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c2.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col6:
                    ...
                    if len(resultados_matematica_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c3 = go.Figure(go.Indicator(
                            mode="number",
                            value=classificacao_aluno_mat_fgv['index'][0]+1,
                            number={'suffix': "º", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': 1, 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c3.update_layout(autosize=False,
            ...
            """
            if len(resultados_matematica_fgv['Nome do aluno(a)']) > 0:
                ponto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_mat_fgv['index'][0]))/numero_candidatos_fgv,0)).find('.')
                texto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_mat_fgv['index'][0]))/numero_candidatos_fgv,0))[0:ponto]
            html_card_header_destaques_mat="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #0010B3; padding-top: 60px; width: 495px;
            height: 150px;">
            ...
            with st.container():
                ...
                with col2:
                # create the bins
                    counts, bins = np.histogram(resultados_gerais_disciplina3_mat_fgv['Nota na questão'], bins=range(0, 1100, 100))
                    bins = 0.5 * (bins[:-1] + bins[1:])
                    fig = px.bar(x=bins, y=counts, labels={'x':'Nota no simulado', 'y':'Número de alunos'})
                    fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                                plot_bgcolor="#FFF0FC", font={'color': "#9E089E", 'size': 14, 'family': "Georgia"}, height=400,
                    ...
                    if len(resultados_matematica_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig.add_vline(x=int(resultados_matematica_fgv['Nota na questão']), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                    fig.add_vline(x=int(round(truncar(resultados_gerais_disciplina_med_mat_fgv['Nota na questão'][0],-1),0)), line_width=7, line_dash="dash", line_color="#01ECEC", annotation_text="Média", annotation_position="top right")
                    fig.update_xaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=6, rangemode="tozero",
                                showgrid=False, gridwidth=0.5, gridcolor='#f6f6f6')
                    fig.update_yaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=10, rangemode="tozero",
                                showgrid=True, gridwidth=0.5, gridcolor='#f6f6f6')
            ...
            linguagens_detalhes = base_alunos_fizeram_fgv[base_alunos_fizeram_fgv['Disciplina'] == 'Língua Portuguesa']
            ...
            html_header_lin="""
            <h2 style="font-size:200%; color: #9E089E; font-family:Georgia"> LÍNGUA PORTUGUESA<br>
            <hr style= "  display: block;
            margin-top: 0.5em;
            margin-bottom: 0.5em;
            margin-left: auto;
            ...
            with st.container():
                ...
                with col2:
                    st.markdown(html_card_header1_disc, unsafe_allow_html=True)
                    if len(resultados_linguagens_fgv['Nome do aluno(a)']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                        ...
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(resultados_linguagens_fgv['Nota na questão'][0],1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_lin_fgv['Nota na questão'][0],-1),0)), 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c1.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col4:
                    ...
                    if len(resultados_linguagens_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c2 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=resultados_linguagens_fgv['Acerto'][0],
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_lin_fgv['Acerto'][0],-1),0))},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c2.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col6:
                    ...
                    if len(resultados_linguagens_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c3 = go.Figure(go.Indicator(
                            mode="number",
                            value=classificacao_aluno_lin_fgv['index'][0]+1,
                            number={'suffix': "º", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': 1, 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c3.update_layout(autosize=False,
            ...
            st.markdown(html_br, unsafe_allow_html=True)
            if len(resultados_linguagens_fgv['Nome do aluno(a)']) > 0:
                ponto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_lin_fgv['index'][0]))/numero_candidatos_fgv,0)).find('.')
                texto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_lin_fgv['index'][0]))/numero_candidatos_fgv,0))[0:ponto]
            html_card_header_destaques_lin="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #0010B3; padding-top: 60px; width: 495px;
            height: 150px;">
            ...
            with st.container():
                ...
                with col2:
                # create the bins
                    counts, bins = np.histogram(resultados_gerais_disciplina3_lin_fgv['Nota na questão'], bins=range(0, 1100, 100))
                    bins = 0.5 * (bins[:-1] + bins[1:])
                    fig = px.bar(x=bins, y=counts, labels={'x':'Nota no simulado', 'y':'Número de alunos'})
                    fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                                plot_bgcolor="#FFF0FC", font={'color': "#9E089E", 'size': 14, 'family': "Georgia"}, height=400,
                    ...
                    if len(resultados_linguagens_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig.add_vline(x=int(resultados_linguagens_fgv['Nota na questão']), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                    fig.add_vline(x=int(round(truncar(resultados_gerais_disciplina_med_lin_fgv['Nota na questão'][0],-1),0)), line_width=7, line_dash="dash", line_color="#01ECEC", annotation_text="Média", annotation_position="top right")
                    fig.update_xaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=6, rangemode="tozero",
                                showgrid=False, gridwidth=0.5, gridcolor='#f6f6f6')
                    fig.update_yaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=10, rangemode="tozero",
                                showgrid=True, gridwidth=0.5, gridcolor='#f6f6f6')
            ...
            ingles_detalhes = base_alunos_fizeram_fgv[base_alunos_fizeram_fgv['Disciplina'] == 'Inglês']
        
            ingles_detalhes_media = ingles_detalhes.groupby('Assunto').mean(['Acerto']).reset_index()
            ingles_detalhes["Login do aluno(a)"] = ingles_detalhes["Login do aluno(a)"].apply(extract_login) 
            ...
            ingles_tabela = pd.merge(ingles_aluno_media,ingles_detalhes_media, on = 'Assunto', how = 'right')
            ingles_tabela2 = ingles_tabela.drop(columns = ['Número da questão_x','Número da questão_y','Valor da questão_x','Valor da questão_y','Nota na questão_x','Nota na questão_y','Tempo na questão_x','Tempo na questão_y'])
            ...
            ingles_tabela3 = pd.merge(ingles_tabela2,ingles_aluno_media3, on = 'Assunto', how = 'left')
            ...
            html_header_ing="""
            <h2 style="font-size:200%; color: #9E089E; font-family:Georgia"> INGLÊS<br>
            <hr style= "  display: block;
            margin-top: 0.5em;
            margin-bottom: 0.5em;
            margin-left: auto;
            ...
            border-width: 1.5px;"></h2>
            """
            st.markdown(html_header_ing, unsafe_allow_html=True)
            ### Block 1#########################################################################################
            with st.container():
                col1, col2, col3, col4, col5, col6, col7 = st.columns([1,20,1,20,1,20,1])
                with col1:
                ...
                with col2:
                    st.markdown(html_card_header1_disc, unsafe_allow_html=True)
                    if len(resultados_ingles_fgv['Nome do aluno(a)']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                        ...
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(resultados_ingles_fgv['Nota na questão'][0],1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_ing_fgv['Nota na questão'][0],-1),0)), 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c1.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                    ...
                    st.markdown(html_card_footer1_disc, unsafe_allow_html=True)
                    st.markdown(html_br, unsafe_allow_html=True)
                    st.markdown(html_card_footer1_disc_med_ing, unsafe_allow_html=True)
                with col3:
                    st.write("")
                with col4:
                    st.markdown(html_card_header2_disc, unsafe_allow_html=True)
                    if len(resultados_ingles_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c2 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=resultados_ingles_fgv['Acerto'][0],
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_ing_fgv['Acerto'][0],-1),0))},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c2.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                    ...
                    st.markdown(html_card_footer2_disc, unsafe_allow_html=True)
                    st.markdown(html_br, unsafe_allow_html=True)
                    st.markdown(html_card_footer2_disc_med_ing, unsafe_allow_html=True)
                with col5:
                    st.write("")
                with col6:
                    st.markdown(html_card_header3_disc, unsafe_allow_html=True)
                    if len(resultados_ingles_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c3 = go.Figure(go.Indicator(
                            mode="number",
                            value=classificacao_aluno_ing_fgv['index'][0]+1,
                            number={'suffix': "º", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': 1, 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c3.update_layout(autosize=False,
            ...
            st.markdown(html_br, unsafe_allow_html=True)
            if len(resultados_linguagens_fgv['Nome do aluno(a)']) > 0:
                ponto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_ing_fgv['index'][0]))/numero_candidatos_fgv,0)).find('.')
                texto = str(round(100*(numero_candidatos_fgv-(classificacao_aluno_ing_fgv['index'][0]))/numero_candidatos_fgv,0))[0:ponto]
            html_card_header_destaques_ing="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #0010B3; padding-top: 60px; width: 495px;
            height: 150px;">
                <h5 class="card-title" style="background-color:#0010B3; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 10px 0;">Você foi melhor que """+texto+"""% dos alunos!</h5>
            ...
            with st.container():
                ...
                with col2:
                # create the bins
                    counts, bins = np.histogram(resultados_gerais_disciplina3_ing_fgv['Nota na questão'], bins=range(0, 1100, 100))
                    bins = 0.5 * (bins[:-1] + bins[1:])
                    fig = px.bar(x=bins, y=counts, labels={'x':'Nota no simulado', 'y':'Número de alunos'})
                    fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                                plot_bgcolor="#FFF0FC", font={'color': "#9E089E", 'size': 14, 'family': "Georgia"}, height=400,
                    ...
                    if len(resultados_ingles_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig.add_vline(x=int(resultados_ingles_fgv['Nota na questão']), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                    fig.add_vline(x=int(round(truncar(resultados_gerais_disciplina_med_ing_fgv['Nota na questão'][0],-1),0)), line_width=7, line_dash="dash", line_color="#01ECEC", annotation_text="Média", annotation_position="top right")
                    fig.update_xaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=6, rangemode="tozero",
                                showgrid=False, gridwidth=0.5, gridcolor='#f6f6f6')
                    fig.update_yaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=10, rangemode="tozero",
                                showgrid=True, gridwidth=0.5, gridcolor='#f6f6f6')
                ...
                with col4:
                    ...
                    st.markdown(html_br, unsafe_allow_html=True)
                    st.markdown(html_br, unsafe_allow_html=True)
                    st.markdown(html_card_header_destaques_ing, unsafe_allow_html=True)
                with col5:
                    st.write("")
            ...
            <tr style="height: 42px; color:#C81F6D; font-size: 16px;text-align: center">
                <th>"""+str(ingles_tabela3['Assunto'][0])+"""</th>
                <th>"""+str(ingles_tabela3['Quantidade de questões'][0])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Individual'][0])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Geral'][0])+"""</th>
                <th>"""+str(ingles_tabela3['Status'][0])+"""</th>
            </tr>
            <tr style="background-color:#f7d4f0; height: 42px; color:#C81F6D; font-size: 16px;text-align: center">
                <th>"""+str(ingles_tabela3['Assunto'][1])+"""</th>
                <th>"""+str(ingles_tabela3['Quantidade de questões'][1])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Individual'][1])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Geral'][1])+"""</th>
                <th>"""+str(ingles_tabela3['Status'][1])+"""</th>
            </tr>
            <tr style="height: 42px; color:#C81F6D; font-size: 16px;text-align: center">
                <th>"""+str(ingles_tabela3['Assunto'][2])+"""</th>
                <th>"""+str(ingles_tabela3['Quantidade de questões'][2])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Individual'][2])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Geral'][2])+"""</th>
                <th>"""+str(ingles_tabela3['Status'][2])+"""</th>
            </tr>
            <tr style="background-color:#f7d4f0; height: 42px; color:#C81F6D; font-size: 16px;text-align: center">
                <th>"""+str(ingles_tabela3['Assunto'][3])+"""</th>
                <th>"""+str(ingles_tabela3['Quantidade de questões'][3])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Individual'][3])+"""</th>
                <th>"""+str(ingles_tabela3['Resultado Geral'][3])+"""</th>
                <th>"""+str(ingles_tabela3['Status'][3])+"""</th>
            </tr>
            </table>
            """

            html_card_header_melhores_resultados_ing="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #9E089E; padding-top: 30px; width: 495px;
            height: 100px;">
                <h5 class="card-title" style="background-color:#9E089E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 10px 0;">Seus melhores resultados</h5>
            ...
            """
            if len(ingles_tabela_verde_ordenado) > 0:
                html_card_header_melhores_resultados1_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #a5ffa5; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#a5ffa5; color:#008800; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🟢 """+str(ingles_tabela_verde_ordenado['Assunto'][0])+"""</p>
                </div>
                </div>
                """
            if len(ingles_tabela_verde_ordenado) > 1:
                html_card_header_melhores_resultados2_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #a5ffa5; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#a5ffa5; color:#008800; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🟢 """+str(ingles_tabela_verde_ordenado['Assunto'][1])+"""</p>
                </div>
                </div>
                """
            if len(ingles_tabela_verde_ordenado) > 2:
                html_card_header_melhores_resultados3_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #a5ffa5; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#a5ffa5; color:#008800; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🟢 """+str(ingles_tabela_verde_ordenado['Assunto'][2])+"""</p>
                </div>
                </div>
                """
            html_card_header_pontos_melhorar_ing="""
            <div class="card">
            <div class="card-body" style="border-radius: 10px 10px 0px 0px; background: #9E089E; padding-top: 30px; width: 495px;
            height: 100px;">
                <h5 class="card-title" style="background-color:#9E089E; color:#FFFFFF; font-family:Georgia; text-align: center; padding: 10px 0;">Pontos que você pode melhorar</h5>
            ...
            """
            if len(ingles_tabela_vermelho_ordenado) > 0:
                html_card_header_pontos_melhorar1_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #ffb1b1; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#ffb1b1; color:#a80000; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🔴 """+str(ingles_tabela_vermelho_ordenado['Assunto'][0])+"""</p>
                </div>
                </div>
                """
            if len(ingles_tabela_vermelho_ordenado) > 1:
                html_card_header_pontos_melhorar2_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #ffb1b1; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#ffb1b1; color:#a80000; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🔴 """+str(ingles_tabela_vermelho_ordenado['Assunto'][1])+"""</p>
                </div>
                </div>
                """
            if len(ingles_tabela_vermelho_ordenado) > 2:
                html_card_header_pontos_melhorar3_ing="""
                <div class="card">
                <div class="card-body" style="border-radius: 10px 10px 10px 10px; background: #ffb1b1; padding-top: 12px; width: 495px;
                height: 50px;">
                    <p class="card-title" style="background-color:#ffb1b1; color:#a80000; font-size: 20px;  font-family:Georgia; text-align: center; padding: 0px 0;">🔴 """+str(ingles_tabela_vermelho_ordenado['Assunto'][2])+"""</p>
                </div>
                </div>
                """
            ...
            with st.container():
                ...
                with col1:
                    st.write("")
                with col2:
                    st.markdown(html_table_ing, unsafe_allow_html=True)
                with col3:
                    st.write("")
                with col4:
                    st.markdown(html_card_header_melhores_resultados_ing, unsafe_allow_html=True)
                    st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_verde_ordenado) > 0:
                        st.markdown(html_card_header_melhores_resultados1_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_verde_ordenado) > 1:
                        st.markdown(html_card_header_melhores_resultados2_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_verde_ordenado) > 2:
                        st.markdown(html_card_header_melhores_resultados3_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)

                    st.markdown(html_br, unsafe_allow_html=True)
                    st.markdown(html_card_header_pontos_melhorar_ing, unsafe_allow_html=True)
                    st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_vermelho_ordenado) > 0:
                        st.markdown(html_card_header_pontos_melhorar1_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_vermelho_ordenado) > 1:
                        st.markdown(html_card_header_pontos_melhorar2_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)
                    if len(ingles_tabela_vermelho_ordenado) > 2:
                        st.markdown(html_card_header_pontos_melhorar3_ing, unsafe_allow_html=True)
                        st.markdown(html_br, unsafe_allow_html=True)

            st.markdown(html_br, unsafe_allow_html=True)

            if resultados_gerais_aluno_fgv['Turma'][0] != turma_eng and resultados_gerais_aluno_fgv['Turma'][0] != turma_cien:
                ciencias_detalhes = base_alunos_fizeram_fgv[base_alunos_fizeram_fgv['Disciplina'] == 'Ciências Humanas']
            else:
                ciencias_detalhes = base_alunos_fizeram_fgv[base_alunos_fizeram_fgv['Disciplina'] == 'Ciências da Natureza']
            ...
            with st.container():
                ...
                with col2:
                    st.markdown(html_card_header1_disc, unsafe_allow_html=True)
                    if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) == 0:
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(0,1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                        ...
                        fig_c1 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=round(resultados_ciencias_fim_fgv['Nota na questão'][0],1),
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_cie_fgv['Nota na questão'][0],-1),0)), 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c1.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col4:
                    ...
                    if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c2 = go.Figure(go.Indicator(
                            mode="number+delta",
                            value=resultados_ciencias_fim_fgv['Acerto'][0],
                            number={'suffix': "", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': int(round(truncar(resultados_gerais_disciplina_med_cie_fgv['Acerto'][0],-1),0))},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c2.update_layout(autosize=False,
                                        width=350, height=90, margin=dict(l=20, r=20, b=20, t=50),
                                        paper_bgcolor="#FFF0FC", font={'size': 20})
                ...
                with col6:
                    ...
                    if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig_c3 = go.Figure(go.Indicator(
                            mode="number",
                            value=classificacao_aluno_fim_fgv['index'][0]+1,
                            number={'suffix': "º", "font": {"size": 40, 'color': "#9E089E", 'family': "Arial"}},
                            delta={'position': "bottom", 'reference': 1, 'relative': False},
                            domain={'x': [0, 1], 'y': [0, 1]}))
                    fig_c3.update_layout(autosize=False,
            ...
            if resultados_gerais_aluno_fgv['Turma'][0] != turma_eng and resultados_gerais_aluno_fgv['Turma'][0] != turma_cien:
                if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) > 0:
                    ponto = str(round(100*((numero_candidatos_fgv-numero_eng_cien_fgv)-(classificacao_aluno_fim_fgv['index'][0]))/(numero_candidatos_fgv-numero_eng_cien_fgv),0)).find('.')
                    texto = str(round(100*((numero_candidatos_fgv-numero_eng_cien_fgv)-(classificacao_aluno_fim_fgv['index'][0]))/(numero_candidatos_fgv-numero_eng_cien_fgv),0))[0:ponto]
            else:
                if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) > 0:
                    ponto = str(round(100*((numero_eng_cien_fgv)-(classificacao_aluno_fim_fgv['index'][0]))/(numero_eng_cien_fgv),0)).find('.')
                    texto = str(round(100*((numero_eng_cien_fgv)-(classificacao_aluno_fim_fgv['index'][0]))/(numero_eng_cien_fgv),0))[0:ponto]
            ...
            with st.container():
                ...
                with col2:
                # create the bins
                    counts, bins = np.histogram(resultados_gerais_disciplina3_fim_fgv['Nota na questão'], bins=range(0, 1100, 100))
                    bins = 0.5 * (bins[:-1] + bins[1:])
                    fig = px.bar(x=bins, y=counts, labels={'x':'Nota no simulado', 'y':'Número de alunos'})
                    fig.update_layout(title={'text': "Distribuição de notas", 'x': 0.5}, paper_bgcolor="#FFF0FC", 
                                plot_bgcolor="#FFF0FC", font={'color': "#9E089E", 'size': 14, 'family': "Georgia"}, height=400,
                    ...
                    if len(resultados_ciencias_fim_fgv['Nome do aluno(a)']) == 0:
                        ...
                        fig.add_vline(x=int(resultados_ciencias_fim_fgv['Nota na questão']), line_width=7, line_dash="dash", line_color="#9E089E", annotation_text="Você está aqui!", annotation_position="top right")
                    fig.add_vline(x=int(round(truncar(resultados_gerais_disciplina_med_cie_fgv['Nota na questão'][0],-1),0)), line_width=7, line_dash="dash", line_color="#01ECEC", annotation_text="Média", annotation_position="top right")
                    fig.update_xaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=6, rangemode="tozero",
                                showgrid=False, gridwidth=0.5, gridcolor='#f6f6f6')
                    fig.update_yaxes(showline=True, linewidth=1, linecolor='#9E089E', mirror=False, nticks=10, rangemode="tozero",
                                showgrid=True, gridwidth=0.5, gridcolor='#f6f6f6')
